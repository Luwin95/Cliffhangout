...
INSERT INTO comment (content, author_id, parent_id, reported) VALUES
  ('Ceci est un commentaire de test', 1, null, false),
  ('Un commentaire enfant de test', 1, 1, true),
  ('Voici un autre commentaire de test', 1, null, false);
