...
public class AdminRemoveReportingOnCommentAction extends AbstractAction implements SessionAware {
    ...
    public String execute() throws Exception {
        if(idComment!=null)
        {
            ...
            if(comment!=null)
            {
                getManagerFactory().getCommentManager().deleteReportingOnComment(comment);
                return SUCCESS;
            }else{
                return ERROR;
            }
